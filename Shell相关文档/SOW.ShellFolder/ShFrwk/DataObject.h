...
public:
   ...
   static CLIPFORMAT s_cfSHELLIDLIST;                // Clipboard format for CFSTR_SHELLIDLIST
   static CLIPFORMAT s_cfDROPEFFECT;                 // Clipboard format for CFSTR_PREFERREDDROPEFFECT
};
