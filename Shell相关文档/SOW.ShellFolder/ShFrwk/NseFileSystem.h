...
typedef enum VFS_CONFIG {
   ...
   VFS_HAVE_QUICKPARSENAME,                          // Our NSE has a fast way to parse file name in only one call
...
public:
   ...
   virtual HRESULT GetChildDirect(LPCWSTR pstrFullName, CNseItem** pItem) = 0;
...
///////////////////////////////////////////////////////////////////////////////
// IFileOperationProgressSink helpers in some file operations

class ATL_NO_VTABLE CFileOpProgSink : 
